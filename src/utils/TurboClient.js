...
const putWithIdRequest = (resource, id, params, actionType) => {
	return dispatch => turbo({site_id: APP_ID}).updateEntity(resource, id, params)
		.then(data => {
			if (actionType != null){
				dispatch({
					type: actionType,
...
export default {
	...
	putWithIdRequest: putWithIdRequest
